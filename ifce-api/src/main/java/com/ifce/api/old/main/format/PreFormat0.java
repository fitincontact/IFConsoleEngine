...
public class PreFormat0 {
    ...
    private Command0 flagFinish = new Command0("f.", "Finish");
    private Command0 flagItems = new Command0("it.", "Items:");
    private Command0 flagInventory = new Command0("i.", "Inventory:");
    private Command0 flagRoom = new Command0("r.", "Room:");
    private String flagSave = "s.";
    private String flagLoad = "l.";
    private String flagSaveList = "sl.";

    protected PreFormat0() {
    }
    ...
    public void setFlagFinish(final Command0 flagFinish) {
    ...
    public void setFlagItems(final Command0 flagItems) {
    ...
    public void setFlagInventory(final Command0 flagInventory) {
    ...
    public void setFlagRoom(final Command0 flagRoom) {
