...
import com.ifce.api.old.main.variable.Command0;
//import com.sun.tools.javac.util.Pair;
//import jdk.javadoc.internal.doclets.toolkit.util.Utils;

import java.io.Serializable;

public class Format0 implements Serializable {
    private static final long serialVersionUID = 7009343869686846026L;

    private static Format0 instance;
    ...
    private Command0 flagFinish;
    private Command0 flagItems;
    private Command0 flagInventory;
    private Command0 flagRoom;
    ...
    protected Format0(
            ...
            final Command0 flagFinish,
            final Command0 flagItems,
            final Command0 flagInventory,
            final Command0 flagRoom,
    ...
    protected static int setInstance(final PreFormat0 preFormat0) {
        if (instance == null) {
            instance = new Format0(
                    preFormat0.getGameName(),
                    preFormat0.getSaveName(),
                    preFormat0.getGameSaveMsg(),
                    preFormat0.getGameLoadMsg(),
                    preFormat0.getFilenameExtension(),
                    preFormat0.getRoomTitleHead(),
                    preFormat0.getRoomDescriptionHead(),
                    preFormat0.getRoomItemsHead(),
                    preFormat0.getRoomItemSplit(),
                    preFormat0.getRoomWaySplit(),
                    preFormat0.getItemRoomDescription(),
                    preFormat0.getItemInvName(),
                    preFormat0.getInventoryHead(),
                    preFormat0.getInventoryItemSplit(),
                    preFormat0.getWayHead(),
                    preFormat0.getConsoleHead(),
                    preFormat0.getUseSplitSymbol(),
                    preFormat0.getGoTxt(),
                    preFormat0.getEnterTxt(),
                    preFormat0.getExitTxt(),
                    preFormat0.getUnDefininedWordIfContains(),
                    preFormat0.getUnDefininedWordIfNotContains(),
                    preFormat0.getUnDefininedWordUse(),
                    preFormat0.getFlagFinish(),
                    preFormat0.getFlagItems(),
                    preFormat0.getFlagInventory(),
                    preFormat0.getFlagRoom(),
                    preFormat0.getFlagSave(),
                    preFormat0.getFlagLoad(),
                    preFormat0.getFlagSaveList()
            );
            return 1;
        } else {
            return 0;
    ...
    public static Format0 getInstance() {
        if (instance == null) {
            final var preFormat = new PreFormat0();
    ...
    public Command0 getFlagFinish() {
        return flagFinish;
    }

    public Command0 getFlagItems() {
        return flagItems;
    }

    public Command0 getFlagInventory() {
        return flagInventory;
    }

    public Command0 getFlagRoom() {
        return flagRoom;
    }
    ...
    public void set(final Format0 f) {
